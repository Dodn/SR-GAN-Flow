...
class PatchHandler3D():
    ...
    def initialize_dataset(self, indexes, shuffle, n_parallel=None, reduction_factor=1):
        '''
            Input pipeline.
        ...
        if reduction_factor > 1:
            ds = ds.shard(num_shards=reduction_factor, index=0)
            print("Reduced dataset:", ds.cardinality().numpy())
