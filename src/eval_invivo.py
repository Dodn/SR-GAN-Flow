...
if __name__ == "__main__":
    ...
    severity = ['Healthy', 'Mild', 'Moderate', 'Severe'][0]
    ...
    data_dir = f"../../data/BRAIN/{severity}/{case}/h5"
    hr_filename = f"{case}.h5"

    lr_filename = f"{case}_LR.h5"
    
    prediction_dir = "../predictions/invivo"
    pred_names = [f'4DFlowNet/{severity}', f'GAN_ESR/{severity}']
    prediction_filename = f"{case}_LR.h5"
